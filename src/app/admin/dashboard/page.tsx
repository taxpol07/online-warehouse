...
// 1. ADIM: TypeScript Interface (Veri yapımızı güvene alıyoruz)
interface Equipment {
  id: string;
  title: string;
  brand: string;
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8 border-b border-slate-800 pb-6">
          <div>
            ...
            <p className="text-slate-400 text-sm mt-1">
              Manage your warehouse inventory and product listings.
            </p>
          </div>
        </div>
        ...
        <div className="bg-[#1e293b] shadow-xl rounded-2xl p-6 md:p-8 mb-10 border border-slate-700">
          ...
          <div className="grid md:grid-cols-2 gap-5">
            <input 
              className="bg-[#0f172a] border border-slate-700 text-white placeholder-slate-500 p-3.5 rounded-xl focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all"
            ...
            />
            <input 
              className="bg-[#0f172a] border border-slate-700 text-white placeholder-slate-500 p-3.5 rounded-xl md:col-span-2 focus:outline-none focus:border-blue-500 transition-all"
              placeholder="Category (e.g., Ovens, Fryers, Grills)"
              value={category}
        ...
        {editingItem && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
            <div className="bg-[#1e293b] border border-slate-700 p-6 md:p-8 rounded-2xl w-full max-w-md shadow-2xl">
